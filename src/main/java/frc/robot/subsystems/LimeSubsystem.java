...
public class LimeSubsystem extends SubsystemBase {
  ...
  public boolean resetOdometryFromTag() {
    ...
    double robotX = -distance * Math.cos(angleRad);  
    double robotY = distance * Math.sin(angleRad);  
